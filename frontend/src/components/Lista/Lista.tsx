...
interface ListaProps {
  ...
  onSelect: (professor: Professor) => void // função que recebe um professor e não retorna nada 
}
          ...
          {props.professores.map((professor) => (
            <ItemLista key={professor.id}>
              ...
              <Informacoes>
                ...
                <Descricao>{FormatadorService.limitarCaracteres(professor.descricao, 200)}</Descricao>
